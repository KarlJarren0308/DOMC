        ...
        <div class="row">
            <div class="three columns">
                <ul class="list-group">
                    ...
                    <li class="list-group-item{{ ($what == 'users' ? ' active' : '') }}"><a href="{{ route('panel.getManage', 'users') }}">Manage Users</a></li>
                    <li class="list-group-item{{ ($what == 'librarians' ? ' active' : '') }}"><a href="{{ route('panel.getManage', 'librarians') }}">Edit Accounts</a></li>
