    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="nine columns">
                <div class="banner">Manage Faculties - Edit</div>
                <p class="text-justify"><strong>Note</strong>: Changing the faculty' birth date won't change its default password. To change faculty' password, please use the "Change Password" module.</p>
                {!! Form::open(array('route' => array('panel.postEdit', $what, $id))) !!}
                    <div class="row">
                        <div class="six columns">
                            <div class="input-block">
                                {!! Form::label('facultyID', 'Faculty Number:') !!}
                                {!! Form::text('facultyID', $faculty_account->Account_Username, array('class' => 'u-full-width', 'placeholder' => 'Enter Faculty Number Here', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                        <div class="six columns">
                            <div class="input-block">
                                {!! Form::label('facultyBirthDate', 'Birth Date:') !!}
                                {!! Form::text('facultyBirthDate', $faculty->Faculty_Birth_Date, array('class' => 'u-full-width', 'placeholder' => 'yyyy-mm-dd', 'maxlength' => '10', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="four columns">
                            <div class="input-block">
                                ...
                                {!! Form::text('facultyFirstName', $faculty->Faculty_First_Name, array('class' => 'u-full-width', 'placeholder' => 'Enter First Name Here', 'required' => 'required')) !!}
                            </div>
                        </div>
                        <div class="four columns">
                            <div class="input-block">
                                {!! Form::label('facultyMiddleName', 'Middle Name:') !!}
                                {!! Form::text('facultyMiddleName', $faculty->Faculty_Middle_Name, array('class' => 'u-full-width', 'placeholder' => 'Enter Middle Name Here')) !!}
                            </div>
                        </div>
                        <div class="four columns">
                            <div class="input-block">
                                {!! Form::label('facultyLastName', 'Last Name:') !!}
                                {!! Form::text('facultyLastName', $faculty->Faculty_Last_Name, array('class' => 'u-full-width', 'placeholder' => 'Enter Last Name Here', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>
