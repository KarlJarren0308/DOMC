                    ...
                    <div class="row">
                        <div class="six columns">
                            <div class="input-block">
                                ...
                                {!! Form::text('librarianID', $librarian_account->Account_Username, array('class' => 'u-full-width', 'placeholder' => 'Enter Librarian ID Here', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                        <div class="six columns">
                            <div class="input-block">
