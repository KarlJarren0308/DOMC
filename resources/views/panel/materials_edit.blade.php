    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="nine columns">
                <div class="banner">Manage Materials - Edit</div>
                            ...
                            <div class="row">
                                <div class="four columns">
                                    <div class="input-block">
                                        ...
                                        {!! Form::text('materialTitle', $material->Material_Title, array('class' => 'u-full-width', 'placeholder' => 'Enter Material Title Here', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                                    </div>
                                </div>
                                <div class="four columns">
                                    <div class="input-block">
