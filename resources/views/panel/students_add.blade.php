    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="nine columns">
                ...
                <p class="text-justify"><strong>Note</strong>: Student's default password is their birth date in <em>yyyy-mm-dd</em> format.</p>
                {!! Form::open(array('route' => array('panel.postAdd', $what))) !!}
                    <div class="row">
                        <div class="six columns">
                            <div class="input-block">
                                {!! Form::label('studentID', 'Student Number:') !!}
                                {!! Form::text('studentID', null, array('class' => 'u-full-width', 'placeholder' => 'Enter Student Number Here', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                        <div class="six columns">
                            <div class="input-block">
                                {!! Form::label('studentBirthDate', 'Birth Date:') !!}
                                {!! Form::text('studentBirthDate', null, array('class' => 'u-full-width', 'placeholder' => 'yyyy-mm-dd', 'maxlength' => '10', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="four columns">
                            <div class="input-block">
                                ...
                                {!! Form::text('studentFirstName', null, array('class' => 'u-full-width', 'placeholder' => 'Enter First Name Here', 'required' => 'required')) !!}
                            </div>
                        </div>
                        <div class="four columns">
                            <div class="input-block">
                                {!! Form::label('studentMiddleName', 'Middle Name:') !!}
                                {!! Form::text('studentMiddleName', null, array('class' => 'u-full-width', 'placeholder' => 'Enter Middle Name Here')) !!}
                            </div>
                        </div>
                        <div class="four columns">
                            <div class="input-block">
                                {!! Form::label('studentLastName', 'Last Name:') !!}
                                {!! Form::text('studentLastName', null, array('class' => 'u-full-width', 'placeholder' => 'Enter Last Name Here', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>
