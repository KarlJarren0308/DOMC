                    ...
                    <div class="row">
                        ...
                        <div class="three columns">
                            <div class="input-block">
                                ...
                                {!! Form::date('userBirthDate', ($user_account->Account_Type == 'Student' ? $user->Student_Birth_Date : $user->Faculty_Birth_Date), array('class' => 'u-full-width', 'placeholder' => 'yyyy-mm-dd', 'maxlength' => '10', 'required' => 'required', 'autofocus' => 'autofocus')) !!}
                            </div>
                        </div>
                        <div class="three columns">
                            <div class="input-block">
